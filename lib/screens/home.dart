    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          if (postalCode == null)
            Text(
                "Codi Postal ${zipCodeController.text} no trobat o no existeix!!"),
          if (postalCode != null) Text('Codi Postal: $postalCode'),
          if (longitude != null)
            Text(
              'Ciutat: $city',
              style: const TextStyle(fontSize: 24),
            ),
          if (longitude != null) Text('Comunitat: $state'),
          if (longitude != null)
            Row(
              ...
              onPressed: () {
                ...
                if (city == 'Linares') {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              MapSituation(city, latitude!, longitude!)));
                }
              },
